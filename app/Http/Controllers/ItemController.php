...
class ItemController extends Controller     //mendefinisikan pembuatan class ItemController yang merupakan extends atau turunan dari class Controller.
{
    ...
    {
        $items = item::all();               //merepresentasikan pengambilan semua data dari folder model item dan menyimpannya menggunakan variable items 
    ...
    {
        $request->validate([            // melakukan validasi dari data yang direquest / sebelumnya dibuat
    ...
    public function edit(Item $item)           //pembuatan function edit, yang digunakan untuk melakukan pengeditan terhadap item yang ada didalam database
    {
